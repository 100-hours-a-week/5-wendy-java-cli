...
public class EscapeRoomRecommend {
    ...
    private void recommendByRegion(Scanner scan, String name, List<EscapeRoom> stores) {
    ...
    private void personalizedRecommendation(Scanner scan, String name, List<HorrorDetails> horrorThemes, List<SubjectiveDetails> themes) {
        ...
        if (wantGenre == 1) {
            RecommendUtils.recommendHorror(scan, searchRegion, horrorThemes);
        } else if (wantGenre==2){
            RecommendUtils.recommendNonHorror(scan, name, searchRegion, themes);
        }
    ...
    public record EscapeRoomData(List<EscapeRoom> stores, List<HorrorDetails> horrorThemes, List<SubjectiveDetails> themes) {
    }
